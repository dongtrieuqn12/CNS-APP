...
package com.example.user.myfinalprojectssc_ver1.Model.ReturnInvoices;
...
public class ReturnInvoices {
    ...
    @Expose
    private List<InvoiceDetail_return> invoiceDetails = null;
    ...
    public List<InvoiceDetail_return> getInvoiceDetails() {
        return invoiceDetails;
    }

    public void setInvoiceDetails(List<InvoiceDetail_return> invoiceDetails) {
